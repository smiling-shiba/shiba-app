...
`shiba-app` is the local game: the Vite + React + Phaser client, the Tauri shell, and the local/custom Colyseus world server that the shell launches as a sidecar.
